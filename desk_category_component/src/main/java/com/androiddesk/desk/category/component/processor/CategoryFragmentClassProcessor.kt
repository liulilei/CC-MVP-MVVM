 ...
 * @date: 2018/12/10
 */
class CategoryFragmentClassProcessor : IActionProcessor {

    override fun getActionName(): String {
        return ComponentCategory.CATEGORY_FRAGMENT_CLASS_ACTION
    }

    override fun onActionCall(cc: CC): Boolean {
        CC.sendCCResult(cc.callId, CCResult.success(ComponentCategory.CATEGORY_FRAGMENT_CLASS_DATA, CategoryFragment::class.java))
        return false
    }
}