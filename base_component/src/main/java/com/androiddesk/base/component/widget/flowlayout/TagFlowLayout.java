package com.androiddesk.base.component.widget.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
     ...
     * 选择项个数超过mSelectedMax
     */
    public interface OnSelectBeyondCallback {
        void onBeyond(int maxNum);
    }

    public OnSelectBeyondCallback mOnSelectBeyondCallback;

    public void setOnSelectBeyondCallback(OnSelectBeyondCallback onSelectBeyondCallback) {
        mOnSelectBeyondCallback = onSelectBeyondCallback;
    }
    ...
    public void setAutoSelectEffect(boolean autoSelectEffect) {
        mAutoSelectEffect = autoSelectEffect;
    }
    ...
    public void setSelectedView(Set<Integer> selectedView) {
        mSelectedView = selectedView;
    }

    public int getSelectedCount() {
        return mSelectedView.size();
    }
        ...
        if (mAutoSelectEffect) {
            if (!child.isChecked()) {
                if (mSelectedMax > 0 && mSelectedView.size() >= mSelectedMax) {
                    if (mOnSelectBeyondCallback != null)
                        mOnSelectBeyondCallback.onBeyond(mSelectedMax);
                    return;
                }
