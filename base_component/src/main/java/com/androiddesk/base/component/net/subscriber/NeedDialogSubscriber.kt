...
class NeedDialogSubscriber<T>(private var context: Context, hasDialog: Boolean, private val subscriberListener: SubscriberListener<T>?) : ResourceSubscriber<T>(), ProgressCancelListener {
