...
public class SwipeRefreshRecyclerView extends SwipeRefreshLayout {
    ...
    private void initView() {
        ...
        //生成主View
        View v = LayoutInflater.from(getContext()).inflate(R.layout.layout_swipe_refresh_recycler, this);
        setEnabled(false);
...
//        setRefreshingColorResources(R.color.color_A9A8AF);
    }
...
//    }
    ...
    public void setRefreshingColorResources(@ColorRes int... colRes) {
        this.setColorSchemeResources(colRes);
    }
