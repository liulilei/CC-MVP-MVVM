 ...
 */
open class ResultDialogSubscriber<T>(private var context: Context, hasDialog: Boolean, private val subscriberListener: SubscriberListener<T>?) : ResourceSubscriber<T>(), ProgressCancelListener {

    private var mProgressDialogHandler: ProgressDialogHandler? = null

    constructor(context: Context, subscriberListener: SubscriberListener<T>) : this(context, true, subscriberListener) {}
